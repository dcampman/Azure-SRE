...
module uami '../Bicep/child_modules/uami.bicep' = if (empty(userAssignedManagedIdentity)) {
...
// adf
module adf '../Bicep/child_modules/adf.bicep' = {
...
//logic app
module logicApp '../Bicep/child_modules/logicApp.bicep' = {
...
// Add Public Storage
module publicStorageAccount '../Bicep/child_modules/storage_account.bicep' = {
...
module eventGridForPublic '../Bicep/child_modules/eventGrid.bicep' = {
...
module eventGridForPrivate '../Bicep/child_modules/eventGrid.bicep' = {
...
//
module ingestTrigger '../Bicep/child_modules/adfTrigger.bicep' = {
  scope: dataAutomationRG
...
module exportTrigger '../Bicep/child_modules/adfTrigger.bicep' = {
  scope: dataAutomationRG
...
module adfManagedPrivateEndpoint '../Bicep/child_modules/adfManagedPrivateEndpoint.bicep' = {
...
module deploymentScript '../Bicep/child_modules/deploymentScript.bicep' = {
